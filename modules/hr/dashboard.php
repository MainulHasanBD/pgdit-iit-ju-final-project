...
try {
    ...
    $stmt->execute();
    $stats['total_job_posting'] = $stmt->fetchColumn() ?: 0;
    ...
    $stats = ['total_job_posting' => 0, 'total_applications' => 0, 'total_teachers' => 0, 'total_onboarding' => 0];
    $recent_activities = [];
}
?>
...
<div class="main-content">
    ...
    <div class="dashboard-stats">
        <div class="stat-card primary">
            <div class="stat-content">
                <div class="stat-number"><?php echo number_format($stats['total_job_posting']); ?></div>
                <div class="stat-label">Total Job Posting</div>
            </div>
            <div class="stat-icon">
        ...
        <div class="stat-card warning">
            <div class="stat-content">
                <div class="stat-number"><?php echo number_format($stats['total_onboarding']); ?></div>
                <div class="stat-label">Total Onbording</div>
            </div>
            <div class="stat-icon">
    ...
    <div class="quick-actions">
        ...
        <a href="job-postings.php?action=add" class="quick-action">
            <div class="quick-action-icon">
                <i class="fas fa-plus"></i>
            </div>
            <div class="quick-action-content">
                <div class="quick-action-title">Add New Job</div>
                <div class="quick-action-description">Create new Job</div>
            </div>
        </a>
        
        <a href="applications.php" class="quick-action">
            <div class="quick-action-icon">
                <i class="fas fa-calendar-alt"></i>
            </div>
            <div class="quick-action-content">
                <div class="quick-action-title">Manage Applications</div>
                <div class="quick-action-description">View and edit applications</div>
            </div>
        </a>
        
        <a href="onboarding.php" class="quick-action">
            <div class="quick-action-icon">
                <i class="fas fa-chart-bar"></i>
            </div>
            <div class="quick-action-content">
                <div class="quick-action-title">Manage Onbording</div>
                <div class="quick-action-description">Manage Onbording</div>
            </div>
        </a>
    </div>
